    ...
    <div className="flex flex-col gap-5 p-6">
      <section className="rounded-2xl border border-ww-border bg-white p-3">
        <div className="wireframe-flow-surface overflow-hidden rounded-xl bg-white">
          <div className="flex flex-col gap-1 border-b border-ww-border px-6 py-5">
            <p className="text-[12px] font-semibold uppercase tracking-[0.12em] text-[#8a887f]">
              {processLabel}
            </p>
            <div className="flex flex-wrap items-end justify-between gap-3">
              <div>
                <h1 className="text-xl font-semibold text-ww-ink">Process flow</h1>
                <p className="mt-1 text-sm text-[#7b796f]">{statusLabel}</p>
              </div>
              <span className="rounded-lg border border-ww-border bg-[#fbfbf8] px-3 py-1.5 text-[12px] font-semibold text-[#6f6d66]">
                Backend only
              </span>
            </div>
          </div>
