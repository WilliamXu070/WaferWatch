...
export const LAYOUT_GAP_Y = 36;
export const LAYOUT_LANE_GAP_X = 140;
export const LAYOUT_LOOP_GAP_X = 75;
export const LAYOUT_LOOP_RADIUS_X = 105;
export const LAYOUT_LOOP_RADIUS_Y = 44;
export const EDGE_CURVE_OFFSET = 24;
export const EDGE_NODE_CLEARANCE = 6;
