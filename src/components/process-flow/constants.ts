...
export const LAYOUT_GAP_Y = 96;
export const LAYOUT_LANE_GAP_X = 380;
export const LAYOUT_LOOP_GAP_X = 180;
export const LAYOUT_LOOP_RADIUS_X = 250;
export const LAYOUT_LOOP_RADIUS_Y = 110;
export const EDGE_CURVE_OFFSET = 48;
export const EDGE_NODE_CLEARANCE = 10;
